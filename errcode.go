...
func main() {
	...
	g.Printf("// Code generated by \"errcode %s\"; DO NOT EDIT.\n", strings.Join(os.Args[1:], " "))
	g.Printf("\n")
...
`)
	...
	outputName := *output
	if outputName == "" {
		baseName := fmt.Sprintf("%s_errcode.go", types[0])
...
func (g *Generator) generate(typeName, limit string) {
	...
	g.Printf("\t// Re-run the errcode command to generate them again.\n")
